-- Packaging and extract SKUs are supplementary (tracked on their own pages).
-- Exclude them from the finished-goods restock plan even if they still have a
-- franchise mapping or were inbounded via procurement into FG warehouses.
