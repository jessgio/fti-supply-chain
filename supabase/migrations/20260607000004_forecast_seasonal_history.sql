-- Extend demand series to 24 months for seasonal uplift calibration (Ramadan, Q4).
-- Base L3M/L6M forecast still uses only the latest 6 completed months in the app.
