-- Demand series for forecast: 6 completed calendar months (excludes current month).
-- Daily qty array is aligned to demand_start_date for L3M/L6M averaging in the app.
