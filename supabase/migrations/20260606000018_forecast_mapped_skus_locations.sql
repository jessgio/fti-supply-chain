-- Restock forecast: franchise-mapped single SKUs only (franchise_id is not null),
-- with warehouse location scoping and negative on-hand support from prior migrations.
