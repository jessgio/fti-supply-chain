...
import {
  deleteExtractInboundDeliveryNote,
  getExtractInboundDeliveryNote,
  updateExtractInboundDeliveryNote,
...
export async function PATCH(
  ...
  try {
    ...
    const supabase = createAdminClient();
    const note = await updateExtractInboundDeliveryNote(supabase, id, {
      po_id: body.po_id,
...
export async function DELETE(
  ...
  try {
    ...
    const { id } = await params;
    const supabase = createAdminClient();
    await deleteExtractInboundDeliveryNote(supabase, id);
