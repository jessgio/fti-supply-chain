...
import { DELIVERY_NOTE_NOTES } from "@/lib/delivery-note/constants";
...
export function generateDeliveryNotePdf(data: DeliveryNotePdfData): Promise<Buffer> {
  ...
  return new Promise((resolve, reject) => {
    ...
    let noteY = rowY + 8;
    DELIVERY_NOTE_NOTES.forEach((text, idx) => {
      doc
        .font("Helvetica")
        .fontSize(8)
        .fillColor("#333333")
